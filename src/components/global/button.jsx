...
export default function Button ({linkHref, btnContent, btnClass, stars}) {
    return(
        <>
            <button>
                <Link href={linkHref} className={"bg-gradient-to-r from-[#4040FB] to-[#D220FF] inline-block   place-content-center px-6 py-2 font-geist font-medium leading-none" + btnClass+
